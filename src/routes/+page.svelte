	...
	<div class="no-select grid w-full grid-cols-2 gap-8">
		{#each $myTask as dataShow, idx}
			<div class="h-42 w-full rounded-lg bg-white p-0 shadow">
				...
				<div class="h-24 w-full justify-items-center" on:dblclick={() => setupClick(idx, 0)}>
							...
							<div class="mt-2 h-full w-5/6">
								...
								<div class="mb-2 grid grid-cols-6">
									...
									<div class="col-span-3 h-4 rounded-full bg-gray-200">
										<div class="h-4 rounded-full bg-blue-600" style="width: {$flowAPersen}%;"></div>
									</div>
								...
								<div class="mb-2 grid grid-cols-6">
									...
									<div class="col-span-3 h-4 rounded-full bg-gray-200">
										<div class="h-4 rounded-full bg-blue-600" style="width: {$flowBPersen}%;"></div>
									</div>
									<div class="pl-2 text-left text-xs font-bold">
								...
								<div class="grid grid-cols-6">
									...
									<div class="col-span-3 h-4 rounded-full bg-gray-200">
										<div class="h-4 rounded-full bg-blue-600" style="width: {$flowCPersen}%;"></div>
									</div>
									<div class="pl-2 text-left text-xs font-bold">
			...
			<div class="mx-auto grid max-w-sm grid-cols-2 gap-2">
				...
				{#if $myTask[setupIndex].mode === taskMode.MODE_MIX}
					...
					<div>
						<label
							for="namaMixA"
							class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Nama MixA</label
						>
						<input
							type="text"
							id="namaMixA"
					...
					<div>
						<label
							for="namaMixB"
							class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Nama MixB</label
						>
						<input
							type="text"
							id="namaMixB"
